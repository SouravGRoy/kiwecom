...
export default async function SuccessPage({
  ...
  // Create a download verification ID
      ...
      <div className="flex gap-4 items-center">
        ...
        <div>
          ...
          <Button className="mt-4 " size="lg" asChild>
            {isSuccess ? (
              <a href={`/products/download/${downloadVerificationId}`} download>
                Download
              </a>
            ) : (
...
async function createDownloadVerification(productId: string) {
  ...
  console.log("Download verification created:", verification);
  return verification.id; // Ensure the ID is returned
}
